...
extension MDLVertexDescriptor {
    static var defaultLayout: MDLVertexDescriptor {
        ...
        offset += MemoryLayout<float3>.stride
        vertexDescriptor.layouts[VertexBuffer.index] = MDLVertexBufferLayout(
            stride: offset
        )
        ...
        vertexDescriptor.layouts[UVBuffer.index] = MDLVertexBufferLayout(
        ...
        vertexDescriptor.layouts[TangentBuffer.index] = MDLVertexBufferLayout(
        ...
        vertexDescriptor.layouts[BitangentBuffer.index] = MDLVertexBufferLayout(
            stride: MemoryLayout<float3>.stride
        )
